...
* In a new tab, create a new Codio project using the Ruby+rails Stack

  ![.guides/img/newProject](.guides/img/newProject.png)
  
  You will follow along in this new tab for the rest of the project.

* Create a new empty directory to hold your new app, and use `git init` in that directory to start versioning it with Git.

  You can access the terminal in Codio (where you would type this command) through the top tool bar Tools > Terminal.
